...
public class Personnage // les personnages peuvent être des héros ou des mob
{
    ...
    //Perte de stats
    public void armure_plus_loose(int perte){
        armure_plus-=perte;
    }
    public void armure_mult_loose(double perte){
        armure_mult-=perte;
    }
    public void armuremag_plus_loose(int perte){
        armuremag_plus-=perte;
    }
    public void armuremag_mult_loose(double perte){
        armuremag_mult-=perte;
    }
    public void esquive_plus_loose(int perte){
        esquive_plus-=perte;
    }
    public void esquive_mult_loose(double perte){
        esquive_mult-=perte;
    }
    public void degat_plus_loose(int perte){
        degat_plus-=perte;
    }
    public void degat_mult_loose(double perte){
        degat_mult-=perte;
    }
    public void degatmag_plus_loose(int perte){
        degatmag_plus-=perte;
    }
    public void degatmag_mult_loose(double perte){
        degatmag_mult-=perte;
    }

    // gain de stats

    public void armure_plus_Gagne(int gain){
        armure_plus+=gain;
    }
    public void armure_mult_Gagne(double gain){
        armure_mult+=gain;
    }
    public void armuremag_plus_Gagne(int gain){
        armuremag_plus+=gain;
    }
    public void armuremag_mult_Gagne(double gain){
        armuremag_mult+=gain;
    }
    public void esquive_plus_Gagne(int gain){
        esquive_plus+=gain;
    }
    public void esquive_mult_Gagne(double gain){
        esquive_mult+=gain;
    }
    public void degat_plus_Gagne(int gain){
        degat_plus+=gain;
    }
    public void degat_mult_Gagne(double gain){
        degat_mult+=gain;
    }
    public void degatmag_plus_Gagne(int gain){
        degatmag_plus+=gain;
    }
    public void degatmag_mult_Gagne(double gain){
        degatmag_mult+=gain;
    }

    public void blessed(int damage){
        actuHp = actuHp-damage;
        if(actuHp<0)
        {
            actuHp=0;
        }
