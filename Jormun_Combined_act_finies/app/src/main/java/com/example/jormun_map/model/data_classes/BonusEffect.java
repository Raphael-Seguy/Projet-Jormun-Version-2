...
public class BonusEffect
{
    ...
    public BonusEffect()
    {
        this.setArmure_plus(0);
        this.setArmure_mult(0);
        this.setArmureMag_plus(0);
        this.setArmureMag_mult(0);
        this.setEsquive_plus(0);
        this.setEsquive_mult(0);
        this.setDegat_plus(0);
        this.setDegat_mult(0);
        this.setDegatMag_plus(0);
        this.setDegatMag_mult(0);
    }
