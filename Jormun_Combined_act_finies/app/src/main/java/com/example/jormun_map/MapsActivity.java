...
import com.example.jormun_map.Temp.Activite_Base;
import com.example.jormun_map.Temp.Activite_Combat;
import com.example.jormun_map.Temp.Activite_Combat_boss;
import com.example.jormun_map.Temp.Activite_Equipement;
import com.example.jormun_map.Temp.Activite_Village;
import com.example.jormun_map.Temp.Activite_villageMap;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void OpenBase(View view) {
        ...
        ClearScreen();
        startActivity(new Intent(MapsActivity.this, Activite_Base.class));
    }
}