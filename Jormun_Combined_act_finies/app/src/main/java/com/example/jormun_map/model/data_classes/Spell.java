...
public class Spell // les sorts possédent des sort positif et/ou négatif
{
    ...
    public Spell(String Nom, int Duree, int Degats, int Type, boolean Magique, BonusEffect BonusDuSort, MalusEffect MalusDuSort,boolean sameCible)
    {
        this.setNom(Nom);
        this.setDuree(Duree);
    ...
    public boolean isSameTarget(){return SameTarget;}

    public void setSameTarget(boolean sameTarget){SameTarget=sameTarget;}
}
