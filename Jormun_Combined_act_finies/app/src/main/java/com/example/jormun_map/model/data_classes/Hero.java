...
public class Hero extends Personnage
{
    ...
    public void Equipement_Base()
    {
        Equipement equip_de_base = new Equipement(5,1,"anneau de base" ,new BonusEffect(),new MalusEffect(),"equip de base");

        ////anneau droit
        this.getEquipe().add(equip_de_base);
        equip_de_base.setNom("collier de base");
        ///anneau gauche
        this.getEquipe().add(equip_de_base);
        equip_de_base.setNom("épée de base");
        equip_de_base.setCategorie(4);
        ///arme droite
        this.getEquipe().add(equip_de_base);
        equip_de_base.setNom("bouclier de base");
        //arme gauche
        this.getEquipe().add(equip_de_base);
        equip_de_base.setNom("jambe de base");
        equip_de_base.setCategorie(3);
        //jambe
        this.getEquipe().add(equip_de_base);
        equip_de_base.setNom("torse de base");
        equip_de_base.setCategorie(2);
        ///torse
        this.getEquipe().add(equip_de_base);
        equip_de_base.setNom("casque de base");
        equip_de_base.setCategorie(1);
        //tête
        this.getEquipe().add(equip_de_base);
    }
