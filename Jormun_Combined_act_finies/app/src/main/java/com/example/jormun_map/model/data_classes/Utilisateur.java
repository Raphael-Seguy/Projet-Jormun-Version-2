...
{
    private ArrayList <Hero> ListHeros = new ArrayList<Hero>();
    private ArrayList <Ressources>Inventaire_ressources = new ArrayList<Ressources>();
    private ArrayList <Lieux> Liste_lieux  = new ArrayList<Lieux>();
    private ArrayList < Village> Liste_village = new ArrayList<Village>();
    private ArrayList < Quete> Liste_quetes = new ArrayList<Quete>();
