...
public enum PrebuildCreationRequest {
    ...
    CREATE_BOSS("CREATE TABLE if not exists " + TablesName.TABLE_BOSS.toString() + "(" +
            TablesColumn.COL_BOSS_IDBOSS + " INTEGER PRIMARY KEY AUTOINCREMENT," +
            TablesColumn.COL_BOSS_PATHJSON + " VARCHAR(255) NOT NULL," +
            TablesColumn.COL_BOSS_IDREL.toString()+" INTEGER NOT NULL)",7),
    CREATE_RESSOURCEZONE("CREATE TABLE if not exists " + TablesName.TABLE_RESSOURCEZONE.toString() + "(" +
            TablesColumn.COL_RESSOURCEZONE_IDZONE + " INTEGER PRIMARY KEY AUTOINCREMENT," +
            TablesColumn.COL_RESSOURCEZONE_PATHJSON + " VARCHAR(255) NOT NULL," +
            TablesColumn.COL_RESSOURCEZONE_IDREL.toString()+" INTEGER NOT NULL)",8);
