...
public class InternalDBBuilder extends SQLiteOpenHelper {
    ...
    public void InitializeTables(SQLiteDatabase db) {
        TablesName[] a_tblnmDatabase = {TablesName.TABLE_USERINFO, TablesName.TABLE_WORLDMAPMIN, TablesName.TABLE_VILLAGE, TablesName.TABLE_MONSTER, TablesName.TABLE_HERO, TablesName.TABLE_CURRENTTEAM,TablesName.TABLE_STRUCTURE, TablesName.TABLE_BOSS};
    ...
    public boolean DropTables(SQLiteDatabase db){
        String[] a_sDatabase = {TablesName.TABLE_USERINFO.toString(), TablesName.TABLE_WORLDMAPMIN.toString(), TablesName.TABLE_VILLAGE.toString(), TablesName.TABLE_MONSTER.toString(), TablesName.TABLE_HERO.toString(), TablesName.TABLE_CURRENTTEAM.toString(),TablesName.TABLE_STRUCTURE.toString(),TablesName.TABLE_BOSS.toString()};
